...
enfoque_actual:
  ...
  - Automatización de procesos e integración de IA en flujos de trabajo
meta: Crecer hacia oportunidades internacionales (Canadá / Europa)
filosofia: "Aprender construyendo, documentar todo, no romper producción"
```

- 🔭 Actualmente diseñando y construyendo sistemas web completos, desde la base de datos hasta la interfaz.
- 🌱 Profundizando en arquitecturas multi-agente e integración de modelos de IA en herramientas de desarrollo.
...
<img src="https://img.shields.io/badge/Arquitecturas%20Multi--Agente-2e6e29?style=flat-square" />
